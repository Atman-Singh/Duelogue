// Adjusted for a dark-themed gradient while maintaining the design.
package gui;
...
/**
 * Team Project Phase 3 -- LoginPage
 * Page displayed when logging in
 *
...
public class LoginPage extends JFrame {
    ...
    public LoginPage(ObjectOutputStream oos, ObjectInputStream ois) {
        this.oos = oos;
        this.ois = ois;
        ...
        gbc.weightx = 0.5;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        JButton loginButton = createRoundedButton("Login", new Color(0, 0, 0, 50));
        loginButton.addActionListener(e -> login());
        frostedGlassPanel.add(loginButton, gbc);

        gbc.gridx = 1;
        JButton createUserButton = createRoundedButton("Create User", new Color(0, 0, 0, 50));
        createUserButton.addActionListener(e -> {
            dispose();
            new CreateUserPage(oos, ois);
        });
        frostedGlassPanel.add(createUserButton, gbc);
